...
extension Moment {
    ...
    static let sampleData = [  // 샘플 데이터 작성
        Moment(
            title: "🍅🥳",
        ...
        Moment(
            ...
            note: "THe chem exan was tough, but I think I did well 🙌 I'm so glad I reached oyut to Guillermo and Lee for a study session. It really helped!",
            imageData: UIImage(named: "Study")?.pngData()
        ),
        Moment(
            title: "Down time",
            note: "So grateful for a relaxing evening agter a busy week",
